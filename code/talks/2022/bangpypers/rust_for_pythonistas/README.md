...
was a virual talk, and the video is hosted here and
[the slides are available here.](https://docs.google.com/presentation/d/1iYmAtGr7jrhYmXe6E8DgXMe-C9j4096WiNEcZSX8wXY)
...
compile, but if you want to see the errors, uncomment any code that is commented
out. To make this easier to find, I'll add a comment above these blocks with
...
_usually_ going to be in a `main.rs` file, and it will instead be `fn main()`.
