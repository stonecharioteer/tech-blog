...
description:
  "Why good documentation means caring about your audience and stating the
...
written about this (in my embarrassingly half-complete idea about
documentation), and I'm always going back to this. Documentation is about
caring. I see a lot of developers who don't write good documentation. But what
_is_ **good** documentation?
...
10. Are there time slots when I _should_ not run this query?
...
Go through those instructions once again and read all these questions. While the
instructions might _seem_ like they're given without context, and that you'd
...
One of my favorite resources on writing documentation is the
[Divio Documentation System](https://documentation.divio.com/). I implore
everyone to read it. But again, documentation is about caring. Far too few
developers care about their work. It's either "I'm too busy", or "I have bigger
fish to fry", or "I'm not going to write docs because you can read the code."
